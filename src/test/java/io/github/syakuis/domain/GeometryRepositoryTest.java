...
@Slf4j
@DataJpaTest
@Sql("classpath:/geometry-data.sql")
class GeometryRepositoryTest {
    ...
    void coordinate() {
        ...
        List<PointEntity> geometry = geometryRepository.findAllByPoint(latitude, longitude, distance, Sort.by(Sort.Direction.DESC, "name"));
